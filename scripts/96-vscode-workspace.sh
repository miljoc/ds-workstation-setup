...
workspace = {
    ...
    "settings": {
        ...
        "[elixir]": {"editor.defaultFormatter": "ExpertLSP.expert", "editor.formatOnSave": True},
        "[phoenix-heex]": {"editor.defaultFormatter": "ExpertLSP.expert", "editor.formatOnSave": True},
        "[elixir-eex]": {"editor.defaultFormatter": "ExpertLSP.expert", "editor.formatOnSave": True},
        "todo-tree.ripgrep": "/usr/bin/rg",
        "todo-tree.ripgrep.ripgrep": "/usr/bin/rg",
        "files.watcherExclude": {"**/_build/**": True, "**/deps/**": True, "**/.git/**": True, "**/node_modules/**": True},
        "search.exclude": {"**/_build": True, "**/deps": True, "**/node_modules": True},
        "files.associations": {
            "*.heex": "phoenix-heex",
            "*.leex": "phoenix-heex",
            "*.sface": "phoenix-heex"
